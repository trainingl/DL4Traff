...
parser.add_argument('--model', type=str, default='E2MLP', help='which model to run')
...
parser.add_argument('--temp_embed_dim', type=int, default=32, help='temp_embed_dim')
...
parser.add_argument("--early_stop", type=eval, default=True, help="number of early stop of training")
...
parser.add_argument("--milestones", type=eval, default=[1,50,80,120,160,200], help="milestones")
