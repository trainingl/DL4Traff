...
from STEMLP_Config import args
from STEMLP_Trainer import Trainer
from models.STEMLP import STEMLP as Network
...
def generate_model_components(args):
    # 1. model
    adj_mx = load_pickle(args.adj_dir)
    model = Network(
        ...
        adp_dim=args.adp_dim,
        adj_mx=adj_mx,
        num_layerA=args.num_layerA, 
        num_layerB=args.num_layerB, 
        num_layerC=args.num_layerC, 
        ...
        if_pre_spatial=args.if_pre_spatial, 
        if_adp_spatial=args.if_adp_spatial
    )
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        checkpoint = "../../log/STEMLP/PMBS08/20240405124036/PMBS08_STEMLP_best_model.pth"
